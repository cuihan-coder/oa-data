<template>
	<view>
		<view class="contain">
			<u-navbar title="新店投资成本" leftText="返回" :fixed="true" @rightClick="rightClick" @leftClick="leftClick">
			</u-navbar>
			<view class="cont-block">
				...
				<view class="flex-data">
					...
					:itemName="['近三个月新店投资决算金额','近三个月新店总数','近三个月新店投资预算金额','预算符合率']">
					</fourblock>
				</view>
