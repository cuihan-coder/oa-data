<template>
	<view>
		<view class="contain">
			<u-navbar title="经营发展管理 — 大客户" leftText="返回" :fixed="true" @rightClick="rightClick" @leftClick="leftClick">
			</u-navbar>
			<view class="cont-block">
				...
				<view class="jxh-kb">
					<view class="title">
						<navigator hover-class="none" url="./dkh_index_tc" class="left">
				...
				<view class="jxh-kb">
					<view class="title">
						<navigator hover-class="none" url="./dkh_index_ac" class="left">
							<image src="../../static/image/circle.png"></image>
							<text>AC:门店营业额</text>
							<image  class="arrow-right" src="../../static/image/arrow-right.jpg"></image>
						</navigator>
