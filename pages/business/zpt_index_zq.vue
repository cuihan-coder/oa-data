<template>
	<view>
		<view class="contain">
			<u-navbar title="自平台 - 自取" leftText="返回" :fixed="true" @rightClick="rightClick" @leftClick="leftClick">
			</u-navbar>
			<view class="cont-block">
				...
				<view class="flex-data">
					<flexData 
					:itemName="['自取在自平台占比','自平台自取营业额']"
					:itemValue="['60.6%','55,555元']"
				...
				processList:[
					{
						...
						accounted:'43.4%',
						money:'5583元',
						pageurl:'/pages/business/mendian?type=zpt'
					},
					{
						name:'杭州人民路地铁站店',
						percentage:30,
