<template>
	<view>
		<view class="contain">
			<u-navbar title="经营发展管理 — 自平台" leftText="返回" :fixed="true" @rightClick="rightClick" @leftClick="leftClick">
			</u-navbar>
			<view class="cont-block">
				...
				<view class="jxh-kb">
					<view class="title">
						<navigator hover-class="none" url="./zpt_index_zq" class="left">
					...
					<!-- 折线统计图 -->
					<lineBar id="main"></lineBar>
				</view>
				<view class="jxh-kb">
					<view class="title">
						<navigator hover-class="none" url="./zpt_index_wm" class="left">
							<image src="../../static/image/circle.png"></image>
							<text>外卖占比</text>
							<image  class="arrow-right" src="../../static/image/arrow-right.jpg"></image>
						</navigator>
